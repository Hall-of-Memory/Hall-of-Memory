...
- Der Browsertest erzeugt sechs Full-Page-Screenshots (`/demo/` und `/demo/rahmen/10/` je Viewport). Der normale `Verify`-Workflow lädt sie über die voll gepinnte `actions/upload-artifact`-Revision `ea165f8d65b6e75b540449e92b4886f43607fa02` als inspizierbares CI-Artefakt hoch.
